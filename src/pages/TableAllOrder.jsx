...
const TableAllOrder = ({ orderData }) => {
  ...
  const columns = [
    ...
    },
    {
      ...
      sorter: (a, b) => new Date(b.orderdate) - new Date(a.orderdate), // Sắp xếp ngày giảm dần
      sortDirections: ["descend"], // Chỉ cho phép sắp xếp giảm dần
    },
    {
      title: "Trạng thái",
      dataIndex: "status",
      ...
      <Modal
        ...
        footer={[
          <button
            ...
            type="button"
            className="text-white bg-[#e74c3c] hover:bg-[#e74c3c]/90 focus:ring-4 focus:outline-none focus:ring-[#c0392b]/50 font-medium rounded-lg text-sm px-3.5 py-2 text-center inline-flex items-center mr-2 mb-2"
          >
            <AiOutlineCloseCircle />
          ...
          <button
            ...
            type="button"
            className="text-white bg-[#2ecc71] hover:bg-[#2ecc71]/90 focus:ring-4 focus:outline-none focus:ring-[#27ae60]/50 font-medium rounded-lg text-sm px-3.5 py-2 text-center inline-flex items-center mr-2 mb-2"
          >
            <AiOutlineMessage />
